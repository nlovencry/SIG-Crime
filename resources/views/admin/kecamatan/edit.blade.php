                        ...
                        <form action="{{ route('kecamatan.update', $kecamatan->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama" placeholder="Masukkan nama"
                                    required value="{{ $kecamatan->nama }}">
                            </div>
                            <div class="form-group">
                                <label for="geojson">Geojson</label>
                                <input type="text" class="form-control" name="geojson" placeholder="Masukkan geojson"
                                    required value="{{ $kecamatan->geojson }}">
                            </div>
                            <div class="form-group">
                                <label for="latitude">Latitude</label>
                                <input type="text" class="form-control" name="latitude"
                                    placeholder="Masukkan latitude" required value="{{ $kecamatan->latitude }}">
                            </div>
                            <div class="form-group">
                                <label for="longtitude">Longtitude</label>
                                <input type="text" class="form-control" name="longtitude"
                                    placeholder="Masukkan longtitude" required value="{{ $kecamatan->longtitude }}">
                            </div>
